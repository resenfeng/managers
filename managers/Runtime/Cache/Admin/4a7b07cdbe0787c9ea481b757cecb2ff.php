                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li><a href="#"><i class="fa fa-indent nav_icon"></i>社团信息修改<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li><a href="<?php echo U('Admin/ClubManager/membersList');?>">主席团</a></li>
        ...
        <div class="col-md-12 graphs">
            ...
            <div class="Seu_AddPresidium">
                <form action="" method="post"  name="club_tenTest" id="club_tenTest">
                    ...
                    <p class="member_phone"><b>会员联系方式</b><input type="text" name="member_phone" id="member_phone" size="30" value="" placeholder="<?php echo ($memberInfo["member_phone"]); ?>"required></p>
                    <p class="submit"><input type="submit"name="submit"value="确认"></p>
                    <p class="back"><input type="button"name="back"value="返回"  onclick="javascript:history.back(-1);"></p>
                </form>
            </div>
            <!-- /#col-md-12 graphs -->
        </div>
