            ...
            <ul class="nav navbar-nav navbar-right">
				<li class="dropdown">
	        		...
	        		<ul class="dropdown-menu">
						...
						<li class="avatar">
							<a href="#">
								<img src="/managers/Public/images/common/2.png" alt=""/>
								<div>New message</div>
								<small>1 minute ago</small>
								<span class="label label-info">NEW</span>
							</a>
						...
						<li class="avatar">
							<a href="#">
								<img src="/managers/Public/images/common/3.png" alt=""/>
								<div>New message</div>
								<small>1 minute ago</small>
							</a>
						</li>
						<li class="avatar">
							<a href="#">
								<img src="/managers/Public/images/common/4.png" alt=""/>
								<div>New message</div>
								<small>1 minute ago</small>
							</a>
						</li>
						<li class="avatar">
							<a href="#">
								<img src="/managers/Public/images/common/5.png" alt=""/>
								<div>New message</div>
								<small>1 minute ago</small>
							</a>
						</li>
						<li class="avatar">
							<a href="#">
								<img src="/managers/Public/images/common/pic1.png" alt=""/>
								<div>New message</div>
								<small>1 minute ago</small>
							</a>
						</li>
			    ...
			    <li class="dropdown">
	        		<a href="#" class="dropdown-toggle avatar" data-toggle="dropdown"><img src="/managers/Public/images/common/1.png"><span class="badge">9</span></a>
	        		<ul class="dropdown-menu">
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li><a href="../index.html">注销账号</a></li>
                    </ul>
                </div>
                <!-- /.sidebar-collapse -->
            </div>
		       ...
		       <div class="activity_box">
		        <div class="scrollbar" id="style-2">
                   <div class="activity-row">
	                 ...
	                 <div class="col-xs-3 activity-img"><img src='/managers/Public/images/common/5.png' class="img-responsive" alt=""/></div>
	                 ...
	                 <div class="col-xs-3 activity-img"><img src='/managers/Public/images/common/3.png' class="img-responsive" alt=""/></div>
	                 <div class="col-xs-8 activity-desc">
                    ...
                    <div class="activity-row">
	                 ...
	                 <div class="col-xs-3 activity-img"><img src='/managers/Public/images/common/1.png' class="img-responsive" alt=""/></div>
	                 <div class="col-xs-8 activity-desc">
                    ...
                    <div class="activity-row1">
	                 ...
	                 <div class="col-xs-3 activity-img"><img src='/managers/Public/images/common/4.png' class="img-responsive" alt=""/></div>
	                 <div class="col-xs-8 activity-desc">
	  ...
	  <div class="span_11">
		<div class="col-md-6 col_4">
		  ...
		  <!----Calender -------->
			...
			<script src="/managers/Public/js/common/underscore-min.js" type="text/javascript"></script>
			<script src= "/managers/Public/js/common/moment-2.2.1.js" type="text/javascript"></script>
			<script src="/managers/Public/js/common/clndr.js" type="text/javascript"></script>
			<script src="/managers/Public/js/common/site.js" type="text/javascript"></script>
			<!----End Calender -------->
		</div>
...
var detail = new Rickshaw.Graph.HoverDetail({
	graph: graph
	      ...
	      <!-- map -->
<link href="/managers/Public/css/common/jqvmap.css" rel='stylesheet' type='text/css' />
<script src="/managers/Public/js/common/jquery.vmap.js"></script>
<script src="/managers/Public/js/common/jquery.vmap.sampledata.js" type="text/javascript"></script>
<script src="/managers/Public/js/common/jquery.vmap.world.js" type="text/javascript"></script>
