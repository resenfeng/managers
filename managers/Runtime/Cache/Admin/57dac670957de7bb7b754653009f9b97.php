...
<ul class="slides">
    ...
    <li class="slide-container">
        <div class="nav">
            <a href="<?php echo U('Admin/Index/jpActIndex2');?>"><label class="next">&#x203a;</label></a>
        </div>
    </li>
</ul>
<div class="container">
...
<!--<div class="fact" style="background-image:url('<?php echo ($show["act_pic"]["0"]); ?>');-webkit-filter: grayscale(0.5);">-->
<div class="fact">
<!--<div class="fact" style="background-image:url('<?php echo ($show["act_pic"]["0"]); ?>');height:140px;width:1300px;">-->
    <div class="container">
        <div class="fact-top">
            <!--<div style="background: rgba(238, 238, 238, 0.45);">-->
                <!--<h3 style="color: #000">精品活动名称</h3>-->
            <!--</div>-->
