...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        ...
        <div class="star_apply">
                <h3 class="page-header text-center">我最喜爱评比参评</h3>
            <form class="join_star form-horizontal" action="<?php echo U('Admin/ClubManager/myFavoriteApply');?>" method="post">
                <div class="form-group col-md-12"></div>
                <div class="form-group col-md-4"></div>
                <div class="form-group col-md-4">
                    <input type="radio" name="if_join" id="y_join" size="30" value="yes" checked>参评
                </div>
                <div class="form-group col-md-4">
                    <input type="radio" name="if_join" id="n_join" size="30" value="no">不参评
                </div>
                <div class="form-group col-md-12"></div>
                <div class="form-group col-md-12"></div>
                <div class="form-group col-md-12"></div>
