...
<div class="app-cam">
	...
	<form action="<?php echo U('Admin/LoginReg/login');?>" method="post" id="form" name="user_form">
		<div class="select1"> <select name="user_type">
			<option name="seu" value="seu">学团联账号</option>
			<option name="club" value="club">社团账号</option>
			<option name="student" value="stu">学生账号</option>
		</select>
		</div>
		...
		<ul class="new">
			<li aglin="center"><p><a href="#">忘记密码 ?</a><a href="/managers/Public/register.html">注册</a></p></li>
