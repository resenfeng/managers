        ...
        <div class="bs-example4 outPlace_applyList div-a " data-example-id="contextual-table">
            ...
            <table  class="table">
                ...
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$s): $mod = ($i % 2 );++$i;?><tr class="active" height="30px">
                        <td><?php echo ($s["indoor_id"]); ?></td>
                        <td><?php echo ($s["iapply_org"]); ?></td>
                        <td><?php echo ($s["iapply_time"]); ?></td>
                        <td><?php echo ($s["iapply_place"]); ?></td>
                        <td>
                            <?php if($s["iapply_state"] == 1): ?>未审批
                                <?php elseif($s["iapply_state"] == 2): ?>通过
                                <?php else: ?>未通过<?php endif; ?>
                        </td>
                        <td><input type="button" class="show_inf" value="查看详情" data-vid="<?php echo ($s["indoor_id"]); ?>"></td>
        ...
        <div class="outPlace_apply" hidden="hidden" >
            <div class="bs-example4 div-a" data-example-id="contextual-table">
                <table  class="table">
                    ...
                    <tr class="active">
                        <td>申请社团名称:<span id="iapply_org"></span></td>
                        <td>场地借用时间:<span id="iapply_time"></span></td>
                    </tr>
                    <tr>
                        <td>用途:<span id="iapply_act"></span></td>
                        <td>预计参与人数:<span id="iapply_num"></span></td>
                    </tr>
                    <tr>
                        <td>申请场地:<span id="iapply_place"></span></td>
                        <td>申请单位:</td>
                    </tr>
                </table>
                <table class="table">
                ...
                <table  class="table">
                    ...
                    <tr class="info">
                        <th>联系人：<span id="iapply_peo"></span></th>
                        <th>联系方式：<span id="iapply_peo_phone"></span></th>
                        <th>填写日期：<span id="iapply_apply_time"></span></th>
                    </tr>
                    <tr>
                        <td></td>
                        <td></td>
...
//			url : "http://localhost:8080/managers9/index.php/Admin/Administrator/outdoorDetail",
            url : "index.php/Admin/Administrator/indoorDetail",
//            url : "http://58.213.164.146:8011/managers/index.php/Admin/Administrator/outdoorDetail",
        ...
        document.getElementById("iapply_org").innerHTML = result["iapply_org"];
        document.getElementById("iapply_time").innerHTML = result["iapply_time"];
        document.getElementById("iapply_act").innerHTML = result["iapply_act"];
        document.getElementById("iapply_num").innerHTML = result["iapply_num"];
        document.getElementById("iapply_peo").innerHTML = result["iapply_peo"];
        document.getElementById("iapply_peo_phone").innerHTML = result["iapply_peo_phone"];
        document.getElementById("iapply_place").innerHTML = result["iapply_place"];
        document.getElementById("iapply_apply_time").innerHTML = result["iapply_apply_time"];
    ...
    function pass() {
        window.location.href="index.php/Admin/Administrator/indoorApprove?id=" + temp;
    }

    function notPass() {
        window.location.href="index.php/Admin/Administrator/indoorRefuse?id=" + temp;
    }

    function deleteApply(id) {
        window.location.href="index.php/Admin/Administrator/deleteIndoor?id=" + id;
    }
</script>
</body>
</html>